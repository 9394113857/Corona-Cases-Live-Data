...
def home():
    ...
    if response.ok:
        ...
        if (message != ""):
            ...
            return render_template("index.html", date=updated, nd_n=new_deaths, td_n=total_deaths, nc_n=new_cases,
                                   tc_n=total_cases, nr_n=new_recovered, tr_n=total_recovered)
    else:
